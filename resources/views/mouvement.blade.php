...
<html lang="en">
    ...
    <div class="container mt-5">
            ...
            <div class="row">
              @foreach ($pointsDeVente as $pointsDeVente )
                <div class="col-md-3" >
                    <a href="{{route('point_de_vente.index2', ['denomination' => $pointsDeVente->denomination])}}" style="color: black; font-size:20px; font-weight:bold;"><div class="square" >{{$pointsDeVente->denomination}}</div></a>
                </div>
              @endforeach
